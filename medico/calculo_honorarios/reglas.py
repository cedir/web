...
class ReglasPorPresentacion(Reglas):
    ...
    def get_honorarios_medicos(self, estudio, importe):
        ...
        id_actuante = estudio.medico_actuante.id  # esto creo que lleva un get() o algo en el medio
        id_solicitante = estudio.medico_solicitante.id  # esto creo que lleva un get() o algo en el medio
        pago = {}

        pago[id_actuante] = importe * porcentajes.actuante / 100
        if id_solicitante != id_actuante:
            pago[id_solicitante] = importe * porcentajes.solicitante / 100
